...
#define GAME_HEIGHT  720			   //ゲームの高さ(ハイト)
...
GAME_SCENE DldGameScene;	//	前回のゲームのシーン
...
//Winmainのプログラミング方法 = (WinAPI)で動いている！
	...
	int nCmdShow)
{
	...
	SetWindowSize(GAME_WIDTH, GAME_HEIGHT);				//ウィンドウの大きさ設定
